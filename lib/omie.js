...
export async function analyzeProductReplenishment(
  ...
  return {
    ...
    cache_vendas: useFastSalesAggregation
      ? "Agregação de vendas faturadas reaproveitada por 15 minutos na instância e por até 24 horas no cache distribuído; a data da agregação é informada em cached_at."
      : null,
